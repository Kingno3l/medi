...
export function ResourceMap({ resources, selectedId, onSelect }: Props) {
  return (
    <div className="relative h-full w-full overflow-hidden rounded-lg border border-border bg-[oklch(0.97_0.005_240)] dark:bg-[oklch(0.22_0.01_240)]">
      <div
      ...
      <svg className="absolute inset-0 h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
        <path d="M0,55 Q30,45 50,52 T100,48" stroke="oklch(0.88 0.005 240 / 0.6)" strokeWidth="1.4" fill="none" />
        <path d="M48,0 Q52,40 50,55 T46,100" stroke="oklch(0.88 0.005 240 / 0.6)" strokeWidth="1.4" fill="none" />
      </svg>

      <div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/30 bg-primary/5"
